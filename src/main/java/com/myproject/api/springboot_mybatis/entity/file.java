...
public class file {
    ...
    public void setFile_property(String file_property) {
    ...
    public String getFile_project() {
        return file_project;
    }

    public void setFile_project(String file_project) {
        this.file_project = file_project;
    }
